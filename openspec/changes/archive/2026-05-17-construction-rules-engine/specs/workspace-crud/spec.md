...
The system MUST allow a workspace to be created, retrieved, updated, and deleted while preserving the full cabinet setup, including construction rules.

#### Scenario: Create and retrieve a workspace

- GIVEN a valid workspace request with an approved construction profile
