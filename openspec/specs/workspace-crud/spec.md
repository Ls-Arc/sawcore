...
Define the minimum workspace lifecycle for v0.1: create, read, update, and delete a project and its cabinet setup, including construction rules and selected material.
